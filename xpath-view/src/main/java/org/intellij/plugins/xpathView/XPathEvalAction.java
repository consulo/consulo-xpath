	...
	private boolean evaluateExpression(EvalExpressionDialog.Context context, XmlElement contextNode, Editor editor, Config cfg)
	{
		...
		try
		{
			...
			if(result instanceof List<?>)
			{
				...
				{
					return Messages.showOkCancelDialog(project, "Sorry, your expression did not return any result", "XPath Result", "OK", "Edit Expression", Messages.getInformationIcon()) == 1;
				}
			}
